...
echo "<option value='0'>0</option>"; // Set the initial value to 0
...
echo "</td>";
            ...
            if (isset($_POST['sbt_top'])) {
                if (isset($_POST['updateData']) && ($_POST['updateData'] == 1)) {
                    ...
                    for ($j = 0; $j < count($st_sid); $j++) {
                        ...
                        $stmtInsert->bindParam(':uid', $sid); // Corrected this line from ':sid' to ':uid'
            ...
            <?php if (isset($_POST['sbt_top'])) : ?>
                <?php
                // Include the send_mail.php file only when the "Save Attendance" button is pressed
