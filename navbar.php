...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=schedule" class="nav-item nav-courses"><span class='icon-field'><i class="fa fa-th-list "></i></span>Schedule</a>
				<a href="index.php?page=class_subject" class="nav-item nav-class_subject"><span class='icon-field'><i class="fa fa-user-friends "></i></span> Class per Topic</a>
				<?php endif; ?>
