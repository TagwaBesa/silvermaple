...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="card">
			...
			<div class="card-body">
				<form action="ajax.php" id="manage-attendance">
...
<div class="modal" id="absentPopup">
    <div class="modal-dialog">
        <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Student Absences</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <!-- Modal body -->
            <div class="modal-body">
                <div id="absentStudentName"></div>
                <p>The student has missed one or more classes. You may want to take action accordingly.</p>
            </div>
...
<script>
    function showAbsentPopup(studentName) {
        $('#absentStudentName').text(studentName);
        $('#absentPopup').modal('show');
    }
    ...
    if (Object.keys(data).length > 0) {
        ...
        Object.keys(data).map(function (k) {
            ...
            // Check if the student has missed one or more classes
            if (absent >= 1) {
                // Trigger the popup
                showAbsentPopup(name);
            }
